      ...
      <div class="row portfolio-container" data-aos="fade-up">
        @foreach ($multipics as $multipic)
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <img src="{{ $multipic->img }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                <h4></h4>
                <p></p>
                <a href="{{ $multipic->img }}" data-gall="portfolioGallery" class="venobox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
      ...
      <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
        @foreach ($brands as $brand)
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <img src="{{ asset($brand->brand_img)}}" class="img-fluid" alt="">
                </div>
            </div>
        @endforeach
        <div class="col-lg-3 col-md-4 col-6">
